...
GitHub Actions will normally repeat these checks when you submit or update your pull request.
...
GitHub Actions will normally run the project's automated checks when the pull request is opened or updated.
